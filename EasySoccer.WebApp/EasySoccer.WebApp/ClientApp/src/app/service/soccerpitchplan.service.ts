...
export class SoccerpitchplanService {
  ...
  public getSoccerPitchPlan(page, pageSize): Observable<any> {
    return this.http
      .get(
        environment.urlApi +
          "soccerpitchplan/get?page=" +
          page +
          "&pageSize=" +
          pageSize
      )
  ...
  public getSoccerPitchPlanBySoccerPitchId(
  ...
  public postSoccerPitchPlan(plan: Soccerpitchplan): any {
    return this.http.post<Soccerpitchplan>(
      environment.urlApi + "soccerpitchplan/post",
      plan
    );
  }

  public patchSoccerPitchPlan(plan: Soccerpitchplan): any {
    return this.http.patch<Soccerpitchplan>(
      environment.urlApi + "soccerpitchplan/patch",
      plan
    );
  }
}
